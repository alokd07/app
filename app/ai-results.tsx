...
const styles = StyleSheet.create({
  ...
  teacherName: { fontSize: 18, fontFamily: fonts.bold, color: palette.navy },
  subjectText: { fontSize: 13, color: palette.muted, marginVertical: 2 },
  ratingRow: { flexDirection: "row", alignItems: "center", gap: 4 },
  ratingText: { fontSize: 12, color: palette.navy, fontFamily: fonts.semiBold },
  tagRow: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  retryText: { color: palette.gold, fontFamily: fonts.semiBold, fontSize: 14 },
});
