...
import { splashColors, fonts } from "../src/theme/colors";
...
const brand = {
  colors: splashColors,
  typography: {
    display: { fontSize: 36, fontFamily: fonts.extraBold, letterSpacing: -1.5 },
    headline: {
      fontSize: 28,
      fontFamily: fonts.extraBold,
      letterSpacing: -0.5,
    },
    body: { fontSize: 14, fontFamily: fonts.medium, letterSpacing: 0.25 },
    micro: { fontSize: 9, fontFamily: fonts.bold, letterSpacing: 3 },
  },
